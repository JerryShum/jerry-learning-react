...
// This will regenerate/refetch the static HTML of this page/route once every day.
...
export default async function Page() {
   ...
   return (
      <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
         ...
         {/* Version of an image if we can statically import it (locally) */}
         ...
         {/* Version of an image if we CANNOT statically import it (from a server or smthn) */}
